...
public class DatabaseHelper extends OrmLiteSqliteOpenHelper {
	...
	private Dao<ORMBlock, Long> blockDao;
	private Dao<ORMExercise, Long> exerciseDao;
	private Dao<ORMExerciseProgress, Long> exerciseProgressDao;
	private Dao<ORMExerciseType, Long> exerciseTypeDao;
	private Dao<ORMWorkout, Long> workoutDao;
	...
	public Dao<ORMBlock, Long> getBlockDao() {
		if (blockDao == null) {
			try {
	...
	public Dao<ORMExercise, Long> getExerciseDao() {
		if (exerciseDao == null) {
			try {
	...
	public Dao<ORMExerciseType, Long> getExerciseTypeDao() {
	...
	public Dao<ORMWorkout, Long> getWorkoutDao() {
		if (workoutDao == null) {
			try {
